...
public class SayfaHaber extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aktivite_haber);
    ...
    private void Nesneler() {
        ...
        wvHaber = (WebView) findViewById(R.id.wvHaber);

        bundle = getIntent().getExtras();

        if (bundle.getString("url") != null) {
            haberurl = bundle.getString("url");
        }
    }
    ...
    private void Olaylar() {
        ...
        Araclar.IcerikDoldur(context, haberurl, wvHaber, Araclar.IcerikTip.Haber, false);
    }
