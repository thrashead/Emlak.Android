...
public class SayfaHaberler extends AppCompatActivity {
    ...
    private EmlakListView emlakListView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aktivite_haberler);
    ...
    private void Nesneler() {
        ...
        emlakListView = (EmlakListView) findViewById(R.id.emlakListView);
    ...
    private void Olaylar() {
        ...
        emlakListView.ListeDoldur(haber.HaberListe(context));
    }
